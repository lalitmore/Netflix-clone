...
//import { db } from './lib/firebase.prod'; // Adjust the import path as needed
...
await addDoc(collection(db, 'series'), {
    ...
    title: 'Peppa Pig',
    description:
      'Peppa, a cheeky little piggy, has numerous adventures with her family and friends in her everyday life.',
    genre: 'children',
    maturity: '0',
    slug: 'peppa-pig',
  });
  await addDoc(collection(db, 'series'), {
    ...
    description:
      'Dora, a seven-year-old Latina girl, embarks on adventures with her monkey companion, Boots, to find something or help somebody.',
    genre: 'children',
    maturity: '0',
  ...
  await addDoc(collection(db, 'series'), {
    ...
    title: 'Arthur',
    description:
      'Arthur, an aardvark, tackles challenges and adventures with his friends and family, learning important lessons along the way.',
    genre: 'children',
    maturity: '0',
    slug: 'arthur',
  });
  await addDoc(collection(db, 'series'), {
    ...
    description:
      'SpongeBob, a sea sponge living in the underwater city of Bikini Bottom, embarks on various adventures with his friends.',
    genre: 'children',
    maturity: '0',
  ...
  await addDoc(collection(db, 'series'), {
    ...
    await addDoc(collection(db, 'films'), {
      ...
      await addDoc(collection(db, 'films'), {
        ...
        title: 'Spirited Away',
        description:
          'In this animated feature by noted Japanese director Hayao Miyazaki, 10-year-old Chihiro and her parents stumble upon a seemingly abandoned amusement park.',
        genre: 'children',
        maturity: '0',
        slug: 'spirited-away',
      });
    ...
    await addDoc(collection(db, 'films'), {
      ...
      await addDoc(collection(db, 'films'), {
        ...
        title: 'La La Land',
        description:
          'Sebastian and Mia are drawn together by their common desire to do what they love. But as success mounts, they are faced with decisions that begin to fray the fabric of their love affair.',
        genre: 'romance',
        maturity: '15',
        slug: 'la-la-land',
      });
      ...
      await addDoc(collection(db, 'films'), {
        ...
        title: 'The Notebook',
        description:
          "Duke reads the story of Allie and Noah, two lovers who were separated by fate, to Ms. Hamilton, an old woman suffering from Alzheimer's, on a daily basis out of his notebook.",
        genre: 'romance',
        maturity: '15',
        slug: 'the-notebook',
      });
